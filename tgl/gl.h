...
TGL_EXPORT void glEnable(int code);
TGL_EXPORT void glDisable(int code);

TGL_EXPORT void glShadeModel(int mode);
TGL_EXPORT void glCullFace(int mode);
TGL_EXPORT void glPolygonMode(int face,int mode);

TGL_EXPORT void glBegin(int type);
TGL_EXPORT void glEnd(void);


#define PROTO_GL1(name)				\
TGL_EXPORT void gl ## name ## 1f(float);	\
TGL_EXPORT void gl ## name ## 1d(double);	\
TGL_EXPORT void gl ## name ## 1fv(float *);		\
TGL_EXPORT void gl ## name ## 1dv(double *);

#define PROTO_GL2(name)				\
TGL_EXPORT void gl ## name ## 2f(float ,float);	\
TGL_EXPORT void gl ## name ## 2d(double ,double);	\
TGL_EXPORT void gl ## name ## 2fv(float *);		\
TGL_EXPORT void gl ## name ## 2dv(double *);

#define PROTO_GL3(name)				\
TGL_EXPORT void gl ## name ## 3f(float ,float ,float);	\
TGL_EXPORT void gl ## name ## 3d(double ,double ,double);	\
TGL_EXPORT void gl ## name ## 3fv(float *);		\
TGL_EXPORT void gl ## name ## 3dv(double *);

#define PROTO_GL4(name)				\
TGL_EXPORT void gl ## name ## 4f(float ,float ,float, float );	\
TGL_EXPORT void gl ## name ## 4d(double ,double ,double, double );	\
TGL_EXPORT void gl ## name ## 4fv(float *);		\
TGL_EXPORT void gl ## name ## 4dv(double *);
...
/* opengl 1.2 arrays */
TGL_EXPORT void glEnableClientState(GLenum array);
TGL_EXPORT void glDisableClientState(GLenum array);
TGL_EXPORT void glArrayElement(GLint i);
TGL_EXPORT void glVertexPointer(GLint size, GLenum type, GLsizei stride, 
                     const GLvoid *pointer);
TGL_EXPORT void glColorPointer(GLint size, GLenum type, GLsizei stride, 
                     const GLvoid *pointer);
TGL_EXPORT void glNormalPointer(GLenum type, GLsizei stride, 
                      const GLvoid *pointer);
TGL_EXPORT void glTexCoordPointer(GLint size, GLenum type, GLsizei stride, 
                       const GLvoid *pointer);

/* opengl 1.2 polygon offset */
TGL_EXPORT void glPolygonOffset(GLfloat factor, GLfloat units);

/* non compatible functions */

TGL_EXPORT void glDebug(int mode);

TGL_EXPORT void glInit(void *zbuffer);
