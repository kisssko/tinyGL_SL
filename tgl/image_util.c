...
void tgl_convertRGB_to_5R6G5B(unsigned short *pixmap,unsigned char *rgb,
                             int xsize,int ysize)
{
  int i,n;
  unsigned char *p;
...
void tgl_convertRGB_to_8A8R8G8B(unsigned int *pixmap, unsigned char *rgb,
                               int xsize, int ysize)
{
    int i,n;
    unsigned char *p;
...
void tgl_resizeImage(unsigned char *dest,int xsize_dest,int ysize_dest,
...
void tgl_resizeImageNoInterpolate(unsigned char *dest,int xsize_dest,int ysize_dest,
                                 unsigned char *src,int xsize_src,int ysize_src)
{
