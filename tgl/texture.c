...
#define gl_resizeImageNoInterpolate tgl_resizeImageNoInterpolate
#define gl_convertRGB_to_5R6G5B tgl_convertRGB_to_5R6G5B
#define gl_convertRGB_to_8A8R8G8B tgl_convertRGB_to_8A8R8G8B
...
TGL_EXPORT void glGenTextures(int n, unsigned int *textures)
{
...
TGL_EXPORT void glDeleteTextures(int n, const unsigned int *textures)
{
  GLContext *c=gl_get_context();
  int i;
  GLTexture *t;
...
void glopBindTexture(GLContext *c,GLParam *p)
{
  ...
  if (!t) t=alloc_texture(c,texture);
  c->current_texture=t;
}
